...
__package_name__ = 'tcex_app_testing'
__url__ = 'https://github.com/ThreatConnect-Inc/tcex-app-testing'
__version__ = '0.0.1'
__download_url__ = f'https://github.com/ThreatConnect-Inc/tcex-app-testing/tarball/{__version__}'
